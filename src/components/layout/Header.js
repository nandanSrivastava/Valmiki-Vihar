...
const Header = () => {
  ...
  return (
    <>
      ...
      <div
        id="site-header"
        className="w-full bg-[#16bcd7] text-black py-6 px-4 md:py-10 md:px-12 overflow-visible sticky top-0 z-50"
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4 px-2 md:px-4">
          ...
          <div className="flex-1 text-center md:text-left px-2 md:px-6">
            <div className="flex flex-col md:flex-row md:items-baseline md:justify-start md:space-x-6">
              <h2 className="text-lg sm:text-xl md:text-5xl font-extrabold text-yellow-300 tracking-wider">
                VALMIKI VIHAR
              </h2>
              <h3 className="mt-1 md:mt-0 text-sm sm:text-lg md:text-3xl font-black text-black md:leading-none">
                TOUR AND TRAVELS
              </h3>
            </div>

            <p
              className="mt-1 text-sm sm:text-base md:text-xl font-medium text-black/90"
              style={{ fontFamily: "sans-serif" }}
            >
              "किफायती यात्रा, शानदार अनुभव"
            </p>
            <p className="mt-2 text-sm md:text-lg font-semibold italic tracking-wide">
